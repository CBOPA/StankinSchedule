Данный репозиторий является форком [проекта расписания](https://github.com/Nikololoshka/ProjectPepega). Цель форка: исправление ошибок, связанных с парсингом при импорте PDF-расписания
